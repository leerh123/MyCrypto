#include "SHA3_256.h"
string sha3_256_hex(string);
SHA3_256::SHA3_256() :HashSuperClass() {}
SHA3_256::SHA3_256(string s) :HashSuperClass(s) {}
string SHA3_256::hexdigest() {
	return sha3_256_hex(text);
}
...
#include <string>
std::string sha3_256_hex(std::string input);
#include <cstdint>
#include <cstdio>
#include <cstdlib>
#include <cstring>
...
#define foldP(I, L, F)								\
	...
	static inline int hash_(uint8_t* out, size_t outlen,
...
#define defsha3(bits)													\
	int sha3_##bits(uint8_t* out, size_t outlen,						\
		...
		return hash_(out, outlen, in, inlen, 200 - (bits / 4), 0x01);	\
	}
